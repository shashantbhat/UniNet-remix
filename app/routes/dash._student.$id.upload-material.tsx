...
//     if (!file || !title || !uploaderId || !universityId) {
...
//       ) VALUES ($1, $2, $3, $4, $5)
//     `;
//     const values = [data?.id, data?.university_id, title, description, fileUrl];
...
//         <div className="mb-4">
//           <label className="block mb-2 text-sm font-medium">Uploader ID</label>
//           <input
//             type="text"
//             name="uploaderId"
